...
public interface Constants {
	...
	//public static final String URL = "http://195.66.136.204:3000"; //test server
	...
	public static final String DATEFORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSSSSS'Z'";
	//public static final String DATEFORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ"; //old date format
